                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item" href="{{route('users.edit',$user)}}"><i class="bx bx-edit-alt me-1"></i>Edit</a>
                        <a class="dropdown-item" href="javascript:{}" onclick="document.getElementById('remove_to_trush_user_{{$user->id}}').submit();"><i class="bx bx-trash me-1"></i>
                      ...
                      <a class="dropdown-item" href="javascript:{}" onclick="document.getElementById('force_delete_user_{{$user->id}}').submit();"><i class="bx bx-trash me-1"></i>
