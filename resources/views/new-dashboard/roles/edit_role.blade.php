...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="col-xxl">
        <div class="card mb-6">
          ...
          <div class="card-body">
            <form action="{{route('roles.update', $role)}}" method="POST" id="create_session">
                @method('PUT')
                @csrf
              <div class="row mb-6">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-merge">
                    ...
                    <input name="name" value="{{$role->name}}" type="text" class="form-control" id="basic-icon-default-fullname" placeholder="Admin" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
                  </div>
                </div>
              </div>
