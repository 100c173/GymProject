      ...
      <div class="row">
        <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-3">
                  <p class="mb-0">Grants for roles</p>
                </div>
                <div class="col-sm-9">
            ...
            <div class="d-flex justify-content-end mb-4">
                <a href="{{route('permissions.edit',$permission)}}" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-warning me-2">
                    <i class="fas fa-pencil-alt"></i>
                    Edit
                </a>
                <a class="btn btn-danger" href="javascript:{}" onclick="document.getElementById('remove_to_trush_session_{{$permission->id}}').submit();">
                    <form id="remove_to_trush_session_{{$permission->id}}" action="{{ route('permissions.destroy', $permission) }}" method="POST" style="display: none;">
                        @csrf 
                        @method('DELETE')
                    </form>
                    Delete
