  ...
  <div class="col-xxl">
        <div class="card mb-6">
          <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Edit Time</h5>
            {{-- <small class="text-muted float-end">Merged input group</small> --}}
          </div>
          <div class="card-body">
            <form action="{{route('times.update',$time)}}" method="POST" id="create_time">
              @csrf
            @method('PUT')
              <div class="row mb-6">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-merge">
                    <input name="day" value="{{$time->day}}" class="form-control" type="date" id="html5-date-input"/>
                  </div>
                </div>
              </div>
              ...
              <div class="row mb-6">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-merge">
                    <input name="start_time" value="{{$time->start_time}}" class="form-control" type="time" id="html5-time-input" />
                  </div>
                </div>
              </div>
              ...
              <div class="row mb-6">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-merge">
                    <input name="end_time" value="{{$time->end_time}}" class="form-control" type="time" id="html5-time-input" />
                  </div>
                </div>
              </div>
