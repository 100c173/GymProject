...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="col-xxl">
        <div class="card mb-6">
          ...
          <div class="card-body">
            <form action="{{route('plans.store')}}" method="POST" id="create_user">
              @csrf
              <div class="row mb-6">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-merge">
                    ...
                    <input name="name" type="text" class="form-control" id="basic-icon-default-fullname" placeholder="GYM" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
                  </div>
                </div>
              </div>
              <div class="row mb-6">
              ...
              <div class="row mb-6">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-merge">
                    ...
                    <input min="1" type="number" class="form-control" id="inputNumberofmembers" name="price" placeholder="$30">
                  </div>
                </div>
              </div>
              ...
              <div class="row mb-6">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-merge">
                    ...
                    <input min="30" type="number" class="form-control" id="inputNumberofmembers" name="period" placeholder="90 Days">
                  </div>
                </div>
              </div>
            ...
            <div class="row mb-6">  
              <div class="col-sm-4 d-flex align-items-center mt-3">
                <div class="form-check me-2">
                    <input class="form-check-input" type="radio" name="with_trainer" checked value="1" id="with_trainer_yes" {{ request('with_trainer') == '1' ? 'checked' : '' }}>
