            ...
            @foreach ($appointments as $appointment)
              <tr>
                ...
                <td>
                  ...
                  <a href="/appointments/update_status/{{$appointment->id}}/1"><button class="btn rounded-pill btn-success btn-sm accept" >Accept</button></a>
                  <a href="/appointments/update_status/{{$appointment->id}}/0"><button class="btn rounded-pill btn-danger btn-sm reject" >Reject</button></a> 
                  @endif
