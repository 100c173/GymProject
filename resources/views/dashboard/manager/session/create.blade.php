            ...
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                    <form action="{{route('sessions.store')}}" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" name="description" id="inputDescription" placeholder="SessionDescription"></textarea>
                            <label for="inputDescription">Session Description</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input class="form-control" id="inputNumberofmembers" name="members_number" placeholder="NumberOfMembers">
